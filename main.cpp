...
int main(int argc, char *argv[]) {
	...
	//	obraz.negative();
		...
		obraz.HMTtransformation(atoi(argv[3]));// , tab1, tab2);
...
void Help()
{
	...
	cout << "--hraleigh [original file] [Gmin]\n";
	...
	cout << "--dilation [source file][1-10]\n";
	cout << "--erosion [source file] [1-10]\n";
	cout << "--opening [source file][1-10]\n";
	cout << "--closing [source file] [1-10]\n";
	cout << "--HMT [source file] [11 or 12] [type for 11 -> 1-4, for 12 -> 1-8] \n";
